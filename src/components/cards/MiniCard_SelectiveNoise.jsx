...
const footerText = <>{cds.length} columns · variance ratio {ratio.toFixed(1)}× · noise differs {ratio.toFixed(1)}× across columns · Bartlett χ²={result.bartlettChi} · df={result.df} · {fmtPBadge(result.primaryP)}</>;
