...
import { CR, FS, FW, M } from "../../constants/tokens.js";

export function FlagBadge({ flag }) {
  const s=FLAG_STYLES[flag]||FLAG_STYLES["N/A"];
  return (
    <span style={{display:"inline-flex",alignItems:"center",gap:"5px",background:s.bg,border:"1px solid "+s.border,color:s.text,padding:"3px 10px",borderRadius:CR.MD,fontSize:FS.xs,fontWeight:FW.BOLD,...M,letterSpacing:"0.06em",whiteSpace:"nowrap"}}>
      {flag==="ERROR"
