  ...
  return (
    <div>
      ...
      {data&&(
        ...
        {data&&assay==="general"&&<div style={{fontSize:FS.T3,color:UI.WARN.text,marginBottom:"4px"}}>Select a data type for instrument-specific noise flagging{assaySuggestion&&(()=>{
