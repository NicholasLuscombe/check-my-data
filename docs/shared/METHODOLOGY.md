...
**Reinstatement is a measurement, not a redesign.** Bound `s` in real deposited data and the test returns behind an `s`-gate, or the suspension becomes permanent on evidence. See `docs/shared/S350-PAIRED-DESIGN-DISPOSITION.md` and P65.
