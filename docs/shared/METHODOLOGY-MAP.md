...
2026-04-21 (S110 — Track E (a) Blocked Mahalanobis landed per METHODOLOGY-TESTS.md §2.6b. Dim III sub-group C gains one active test. Test count 26 → 27. Fisher exempt list extended to 3 entries (Excess Kurtosis, Windowed Autocorrelation, Blocked Mahalanobis). See STATUS.md §S110 + METHODOLOGY-TESTS.md §2.6b.)
