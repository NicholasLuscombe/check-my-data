...
| Test7a | How this test works | How this test works description is overly long and cites methodology doc which is an internal document. | DONE S270 `49cb1c5` (method-prose pass — ALREADY-ACCEPTABLE): S270 audit found this block already short/de-jargoned/de-cited at live source (Arc B / interim edits); the methodology.md-citation defect was extinct suite-wide. Tag was stale, no edit needed. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works length / de-jargon / drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test8a | How this test works | How this test works description is overly long and cites methodology doc which is an internal document - same for implications etc | DONE S270 `49cb1c5` (method-prose pass — ALREADY-ACCEPTABLE): S270 audit found this block already short/de-jargoned/de-cited at live source (Arc B / interim edits); the methodology.md-citation defect was extinct suite-wide. Tag was stale, no edit needed. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works / implications length + de-jargon + drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test10a | DS10 | How this test works etc are too long and jargony. | DONE S270 `49cb1c5` (method-prose pass — ALREADY-ACCEPTABLE): S270 audit found this block already short/de-jargoned/de-cited at live source (Arc B / interim edits); the methodology.md-citation defect was extinct suite-wide. Tag was stale, no edit needed. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works length / de-jargon / drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test11b | DS17 | How this test works etc is non-intuitive. | DONE S270 `49cb1c5` (method-prose pass — ALREADY-ACCEPTABLE): S270 audit found this block already short/de-jargoned/de-cited at live source (Arc B / interim edits); the methodology.md-citation defect was extinct suite-wide. Tag was stale, no edit needed. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works length / de-jargon / drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test14a | DS11 | The line shows lag-k means across pairs; dots are per-lag values. The mean ± 95% CI marker at lag 1 carries the verdict — average serial correlation across pairs is reliably above zero when the interval excludes the dashed reference. - length text after the plot. | ROUTES-ELSEWHERE (plot/legend caption, not how-it-works) — S271 closeout audit 2a: this row points at the plot/legend caption surface, homed to Arc A caption tail / Arc C legend, NOT the method-prose body (which closed S270). Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works / implications length + de-jargon + drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test14a | DS11 | Long explanatory text in how this test works. | DONE S270 `49cb1c5` (method-prose pass): how-it-works body split one-job-per-sentence, parenthetical preserved. S270 audit confirmed this as one of the 3 genuinely too-long blocks of the tagged 16. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works length / de-jargon / drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test15b | DS01 | How this test works is too long and refers to methodology.md. | DONE S270 `49cb1c5` (method-prose pass — ALREADY-ACCEPTABLE): S270 audit found this block already short/de-jargoned/de-cited at live source (Arc B / interim edits); the methodology.md-citation defect was extinct suite-wide. Tag was stale, no edit needed. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works length / de-jargon / drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test16a | DS22 | Again How this works text is too long. | DONE S270 `49cb1c5` (method-prose pass — ALREADY-ACCEPTABLE): S270 audit found this block already short/de-jargoned/de-cited at live source (Arc B / interim edits); the methodology.md-citation defect was extinct suite-wide. Tag was stale, no edit needed. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works length / de-jargon / drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
| Test25a | DS16 | How this test works description is way too long. | DONE S270 `49cb1c5` (method-prose pass): how-it-works body split one-job-per-sentence, parenthetical preserved. S270 audit confirmed this as one of the 3 genuinely too-long blocks of the tagged 16. Superseding: Arc B copy transcription shipped S262 `111e5d6` (CCR card, locality-in-prose, cross-refs, parentheticals, verdict text), but the how-it-works length / de-jargon / drop-methodology.md-citation sub-theme was NOT in that scope. Still open. → BANKED as the Arc B method-prose follow-up. |
...
- **Arc B (S261–262, `111e5d6`) — copy transcription DONE, but the method-prose sub-theme was NOT in
  ...
  **CLOSED S270 (`49cb1c5`).** The S270 method-prose audit collapsed the ~16 to 3 genuine too-long
  blocks (Autocorrelation, Baseline Balance, Cross-Condition Consistency), split one-job-per-sentence;
  the other 11 were ALREADY-ACCEPTABLE (Arc B / interim edits had shortened + de-cited them) and the
  methodology.md-citation defect was extinct suite-wide. Two tagged sub-rows (14a, 26a) pointed at the
  plot/legend caption, not the body → routed to Arc A/C caption work. Row cells reconciled this close.
...
**Still genuinely open after S271 closeout** (per `SESSION271-WALK-CLOSEOUT-AUDIT.md`, ~64 open-tagged
row-entries → 3 passes): **(A)** verdict-phrasing card-copy pass (~10 string edits — Benford 1st/2nd,
Terminal digit, Decimal precision, Over-used numbers, RSC lookFor; the direct analogue of the
method-prose pass); **(B)** two dense-card legibility restructures (Duplicated Data, Overall condition
similarity); **(C)** small display defects + carry-ins (ClusterRow icon-gap, SelNoise bar-vs-whisker,
ColumnGoF Direction column, 25a "Col N" label, 13b rename). Everything else is CLOSED (method-prose
cluster → S270; by-design display rows) or ROUTES-ELSEWHERE (reference-line / two-tone / data-model →
S245; legend-vocab → parked #9; axis tail → Arc A; legend → Arc C; the four footer/caption rows;
cross-card chrome; MissingData taxonomy). **~2–3 card-walk sessions remain.**
