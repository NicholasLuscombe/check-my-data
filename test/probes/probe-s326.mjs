...
const ENTRIES = [
  ...
  { label: 'C09', path: `${DIR}/C09.xlsx`, sheet: 'Sheet1' },
  { label: 'C14', path: `${DIR}/C14.xlsx`, sheet: 'Data' },
  { label: 'C15', path: `${DIR}/C15.xlsx`, sheet: 'Data' },
  { label: 'C16', path: `${DIR}/C16.xlsx`, sheet: 'Sheet1' },
  { label: 'C20', path: `${DIR}/C20.xlsx`, sheet: 'Microcosm soil B' },
  { label: 'C22', path: `${DIR}/C22.xlsx`, sheet: 'Exp. WA' },
];
...
writeFileSync('/Users/hedgehog/Projects/cmd-s326-ecology-rerun/probe-s326-out.json', JSON.stringify(all, null, 2));
